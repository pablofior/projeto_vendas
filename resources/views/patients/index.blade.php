        ...
        <div class="col-md-12">
            <div class="box box-success">
                <div class="box-body">
                    ...
                    <a class="btn btn-success pull-right" href="{{route('patients.create')}}">Adicionar</a>
                </div>
            </div>
        </div>
    </div>
...
@push('js')
    <script>
        ...
        function confirmDelete(id)
        {
            $.confirm({
                title: 'Aviso!',
                content: 'Deseja realmente apagar o paciente? Pacientes com consultas marcadas não serão apagados.',
                buttons: {
                    Não: function () {
